...
:ISCMD
:: activate virtenv
start cmd /k "%venvName%\Scripts\activate && echo 'Activated virtual environment successfully: ' %venvName% && pip install napari[all] && pip install napari-annotatorj && echo 'Installed pip packages successfully' && napari"
